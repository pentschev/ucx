...
#### How can I force host tag rendezvous transfers to use CUDA fragments?

For same-node testing, start the server with:
...
IMEX channel. The UCP staging options above do not enable MNNVL by themselves.
